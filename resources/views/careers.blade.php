    ...
    <div class="container my-5">
        <div class="row justify-content-center align-items-center border rounded p-2 shadow">
            <div class="col-12 col-md-6">
                ...
                <p>Ecco cosa farai: Verifica la correttezza dell'articolo e che le notizie non siano false.</p>
                <h2>lavora come redattore</h2>
                <p>Ecco cosa farai: Ha la responsabilità di organizzare la struttura dei contenuti, proporre revisioni redazionali e suggerire l'impostazione grafica nell'ottica di realizzare il progetto editoriale così come concordato con l'editore.</p>
            </div>
            <div class="col-12 col-md-6">
                @if ($errors->any())
