...
<body>
    <div class="es-wrapper-color">
		...
		<![endif]-->
        <table style="padding: 50px" class="es-wrapper" width="100%" cellspacing="0" cellpadding="0">
            <tbody>
                <tr>
                                                                ...
                                                                <tr>
                                                                    <td width="241" class="es-m-p0r es-m-p20b esd-container-frame" valign="top" align="center">
                                                                        <table cellpadding="0" cellspacing="0" width="100%">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-image" style="font-size: 0px;"><a target="_blank"><img class="adapt-img" src="https://gxrhep.stripocdn.email/content/guids/CABINET_44fb8e23a4d19f691b4a912416f5679ac4e9e1a0ebc440e6314d469e3227eac1/images/occhio_del_reporter.png" alt style="display: block;" width="241"></a></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
                                    ...
                                    <td class="esd-stripe" align="center">
                                        <table class="es-content-body" style="background-color: #ffffff;" width="600" cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center">
                                            <tbody>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text es-p30t es-p10b es-p20r es-p20l">
                                                                                        <h1 style="color: #040304;">Abbiamo ricevuto<br>una richiesta</h1>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text es-p30b">
                                                                                        <p style="font-size: 16px; color: #333333;">un nuovo membro si vuole unire al nostro team!</p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                ...
                                                <tr>
                                                    <td class="esd-structure es-p40b es-p40r es-p40l" align="left" bgcolor="#cccccc" style="background-color: #cccccc;">
                                                        <table cellpadding="0" cellspacing="0" width="100%">
                                                            <tbody>
                                                                <tr>
                                                                    <td width="520" class="esd-container-frame" align="center" valign="top">
                                                                            ...
                                                                            <tbody style="">
                                                                                <tr>
                                                                                    <td align="left" class="esd-block-text es-p5t es-p5b">
                                                                                        <h3 style="color: black;">Ciao Occhi Del Reporter,</h3>
                                                                                        <p style="color: black;">C'è un nuovo utente che ci ha inviato una richiesta!</p>
                                                                                        <p style="color: black;"><br></p>
                                                                                        <h4>Richiesta per il ruolo di {{$info['role']}}</h4>
                                                                                        <p style="color: black;">Ricevuta da<br><br></p>
                                                                                        <p style="color: black;">{{$info['email']}}<br><br></p>
                                                                                        <p style="color: black;">Corpo del testo:<br><br></p>
                                                                                        <p style="color: black;">{{$info['message']}}</p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
